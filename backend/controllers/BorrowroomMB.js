import Borrow_room from "../models/BorrowRoomMBmodel.js";
import Users from "../models/Usermodel.js";
import {Op} from "sequelize";
import Room from "../models/Roommbmodel.js";
import { SMTPClient } from 'emailjs';
import moment from "moment-timezone";


export const getBorrowroomMB = async (req, res) => {
    try {
        let response;
...
export const getBorrowroomByIdMB = async(req, res) =>{
    try {
...
export const createBorrowroomMB = async(req, res) =>{
    const {nama_kegiatan,nama, ruangan,dosen_id, jumlah_pengguna,prodi_id,phone,borrow_date,until_date,borrow_time,until_time,nama_pengguna,email} = req.body;
    try {
...
export const createBorrowroomDosenMB = async(req, res) =>{
    const {nama_kegiatan,nama, ruangan,dosen_id,jur_id, prodi_id,phone,borrow_date,until_date,borrow_time,until_time,nama_pengguna,email} = req.body;
    try {
        await Borrow_room.create({
            nama:nama,
            nama_kegiatan: nama_kegiatan,
...
export const createBorrowroomTuMB = async(req, res) =>{
    const {nama_kegiatan,nama, ruangan,dosen_id,jur_id, prodi_id,phone,borrow_date,until_date,borrow_time,until_time,nama_pengguna,email} = req.body;
    try {
        await Borrow_room.create({
            nama:nama,
...
export const updateBorrowroomMB = async(req, res) =>{
    try {
        const borrowroom = await Borrow_room.findOne({
            where:{
                uuid: req.params.id
...
export const deleteBorrowroomMB = async(req, res) =>{
    try {
        const borrowroom = await Borrow_room.findOne({
            where:{
                uuid: req.params.id
...
export const checkRoomAvailabilityMB = async (req, res) => {
    try {
