...
const AddBorrowMB = () => {
  ...
  const checkRoomAvailability = async () => {
    try {
      ...
      const response = await axios.post("http://localhost:5000/checkRoomAvailabilityEL", {
        ruangan: ruangan,
  ...
  const saveBorrow = async (e) => {
    ...
    try {
      ...
      const borrowTime = moment.tz(borrow_time, "HH:mm:ss", "Asia/Jakarta").format("HH:mm:ss");
      const untilTime = moment.tz(until_time, "HH:mm:ss", "Asia/Jakarta").format("HH:mm:ss");
      await axios.post("http://localhost:5000/BorrowroomEL", {
                      ...
                      <div className="content">
                        <form onSubmit={saveBorrow}>
                          ...
                          <FormControl fullWidth>
                            ...
                            >
                              <MenuItem value={1}>R102 - Mechanical Laboratory</MenuItem>
                              <MenuItem value={2}>R104 - Computer Laboratory</MenuItem>
                              <MenuItem value={3}>R401 - Basic Electronics laboratory</MenuItem>
                              <MenuItem value={4}>R402 - WorkSpace</MenuItem>
                              <MenuItem value={5}>R404 - Networking Laboratory (NWL)</MenuItem>
                              <MenuItem value={6}>R405 - Basic Electronics laboratory</MenuItem>
                              <MenuItem value={7}>R406 - Basic Electronics laboratory</MenuItem>
                              <MenuItem value={8}>R501 - Interfacing Laboratory (IFL)</MenuItem>
                              <MenuItem value={9}>R502 - Advance Electronics laboratory (AEL)</MenuItem>
                              <MenuItem value={10}>R506 - Pneumatic Laboratory</MenuItem>
                          ...
                          <FormControl fullWidth>
                            ...
                            >
                              <MenuItem value={19}>Ahmad Riyad Firdaus, S.Si., M.T., Ph.D</MenuItem>
                              <MenuItem value={20}>Daniel Sutopo Pamungkas, S.T.,M.T., Ph.D</MenuItem>
                              <MenuItem value={21}>Eka Mutia Lubis, S.Pd., M.Pd</MenuItem>
                              <MenuItem value={22}>Ika Karlina Laila Nur Suciningtyas, S.Si., M.Si</MenuItem>
                              <MenuItem value={23}>Fauzun Atabiq, S.T., M.Cs</MenuItem>
